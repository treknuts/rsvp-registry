      ...
      <div className="mt-4">
        <div className="accordion" id="accordionExample">
          ...
          <div class="accordion-item">
            ...
            >
              <div class="accordion-body">
                <strong>A:</strong>&nbsp;Dinner options are awaiting the bride
                and grooms taste test coming soon. They are leaning towards a
                buffet style dinner with a couple options for those picky
                eaters.
              </div>
            </div>
          </div>
